...
describe "A user" do 
  ...
  it "accepts an alphanumeric username without spaces" do 
    usernames = ["username123", "username"]
  ...
  it "rejects a non-alphanumberic name or name with spaces" do 
  ...
  it "requires a unique, case insensitive username" do 
	...
	it "is valid with example user_attributes" do 
  ...
  it "has reviews" do 
    ...
    review1 = movie1.reviews.new(stars: 5, comment: "A+! Would see again.")
    review1.user = user
    review1.save!

    review2 = movie2.reviews.new(stars: 3, comment: "OK, not my favorite.")
    review2.user = user
    review2.save!
